...
/* Reading DATA pins                                                          */
#define LCD_DATA_IN           (((GPIOB->IDR & PINS_DATA) >> 4) & 0x0F)

/* Writing value to DATA pins                                                 */
#define LCD_DATA_OUT(x)       GPIOB->ODR = (GPIOB->ODR & ~PINS_DATA) | (x << 4);
...
#define LCD_DATA_DIR_IN       GPIOB->CRL = (GPIOB->CRL & 0x0000FFFF) | 0x44440000;

/* Setting DATA pins to output mode                                           */
#define LCD_DATA_DIR_OUT      GPIOB->CRL = (GPIOB->CRL & 0x0000FFFF) | 0x33330000;
